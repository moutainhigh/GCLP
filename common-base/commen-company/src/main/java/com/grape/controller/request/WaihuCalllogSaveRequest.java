...
public class WaihuCalllogSaveRequest extends RestfulRequest {
    ...
    @NotNull
    @NotEmpty(message = "通话id为空")
    @ApiModelProperty(value = "通话id", example = "", required = true)
    ...
    @NotNull
    @NotEmpty(message = "客户身份证号码为空")
    @ApiModelProperty(value = "客户身份证号码", example = "", required = true)
