...
public class Codeofpoints {//评分规则表

	@Id
	@Column(name = "id", nullable = false, length = 19)
	private String id;//主键id

	@Column(name = "columnname", nullable = true, length = 20)
	private String columnname;//字段名称

	@Column(name = "scoringrubrics", nullable = true, length = 40)
