...
//
public class Exqueryhist implements Serializable {
	...
	@ApiModelProperty(value = "接口返回信息", example = "", dataType="longtext", required = true )
    ...
    public boolean equals(Object that) {
        ...
        Exqueryhist other = (Exqueryhist) that;
